...
print("Files and directories in '", path, "' :",folders)
folders.sort()
print('folders->',folders)
songs=0
artists=0
header=['chart','name','bio','linkName','linkUrl','monthlyListeners','worldRank','L0_city','L0_country','L0_numberOfListeners','L0_region',
